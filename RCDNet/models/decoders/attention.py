...
class BasicTransformerBlock(nn.Module):
    def __init__(self, dim, n_heads, d_head, dropout=0., context_dim=None, gated_ff=True, checkpoint=True):
        super().__init__()
        self.attn1 = CrossAttention(query_dim=dim, heads=n_heads, context_dim=context_dim,dim_head=d_head, dropout=dropout)  # is a self-attention
...
class SpatialTransformer(nn.Module):
    ...
    def __init__(self, in_channels, n_heads, d_head,
                 depth=1, dropout=0., context_dim=None, rearrange_input=False):
        super().__init__()
        self.rearrange_input = rearrange_input
        self.in_channels = in_channels
